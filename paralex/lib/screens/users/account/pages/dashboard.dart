...
import '../../../../service_provider/view/user_drawer.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          // Notification and Logout Icons as actions
          Obx(() {
      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
            ...
            // Paralegal Image Section (First Gesture Detector)
            Padding(
              padding: const EdgeInsets.all(25),
              child: GestureDetector(
                onTap: () => Get.toNamed(Nav.logisticsDeliveryInfo),
                child: Container(
            ...
            // Log2 Image Section (Second Gesture Detector)
            Padding(
              padding: const EdgeInsets.all(25),
              child: GestureDetector(
            ...
            // Gradient Background Section (Positioned)
            Positioned(
              child: Container(
            ...
            // Activity Section (No Activity Yet)
            Positioned(
              child: Padding(
                padding: const EdgeInsets.all(25),
                child: Container(
