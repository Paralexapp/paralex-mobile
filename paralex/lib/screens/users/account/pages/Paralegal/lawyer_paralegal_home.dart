...
class LawyerParalegalDashboard extends StatelessWidget {
  const LawyerParalegalDashboard({super.key});
              ...
              Container(
                child: Row(
                  ...
                  children: [
                    ...
                    MenuWithImages(
                        navTo: () => Get.toNamed(Nav.findAlawyer),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Center(
              child: InkWell(
                onTap: () => Get.toNamed(Nav.lawyerDashboard),
                child: const Icon(
