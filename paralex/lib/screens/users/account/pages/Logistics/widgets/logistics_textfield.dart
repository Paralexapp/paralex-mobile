...
class LogisticsTextfield extends StatelessWidget {
  const LogisticsTextfield({super.key, this.minLines, this.padding,this.hintText, this.keyboardType,this.icon, this.controller, this.borderColor, this.suffixIcon,this.showPrefixIcon = false, this.showSuffixIcon = false, this.maxLines, this.prefix, this.suffix});
...
class LogisticsPhoneField extends StatelessWidget {
  const LogisticsPhoneField({super.key, this.suffixWidget, this.hintText, this.onChanged, this.onCountryChanged, this.controller});
