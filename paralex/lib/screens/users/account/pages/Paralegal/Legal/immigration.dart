...
class ImmigrationRegistration extends StatelessWidget {
  const ImmigrationRegistration({super.key});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Image.asset(
              'assets/images/immigration_logo.jpg',
              height: 250,
              fit: BoxFit.cover,
            ),
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  CustomButton(
                      ontap: () => Get.toNamed(Nav.immigrationStepOne),
                      desiredWidth: 90,
                      buttonText: "Next",
